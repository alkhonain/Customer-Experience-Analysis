...
df_real <- read_csv("Dataset/raw_yelp_review_data.csv")
...
wordcloud(words = df_rev$word, freq = df_rev$freq, min.freq = 1,           max.words=200, random.order=FALSE, rot.per=0.35,            colors=brewer.pal(8, "Dark3"))
```
